    ...
    return (
        <section style={bannerStyle} className="about-banner-section">
            ...
            <div className="deco-dots">
                <img src="https://wp.rrdevs.net/edcare/wp-content/themes/edcare/assets/img/shapes/dot-shape.png"/>
            </div>
            <div className="deco-ring">
                <img src="https://wp.rrdevs.net/edcare/wp-content/themes/edcare/assets/img/shapes/cta-shape-2.png"/>
            </div>

            <Container className="position-relative ms-0" style={{ zIndex: 2 }}>
